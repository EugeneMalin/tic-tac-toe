...
* добавление jsdoc
* исправление проблемы с проверкой на победу: направлений должно быть 4, длинну увеличить в 2 раза, для проверки случаев победы при заполнении линии вставкой посередине, а не только в крайние точки
